...
fdescribe('HomeComponent', () => {
  ...
  beforeEach(() => {
    mockMovieService = jasmine.createSpyObj(['getTrending']);
    MOVIES = [
  ...
  it('should do nothing', () => {
    mockMovieService.getTrending.and.returnValue(of(MOVIES));
    fixture.detectChanges();

    expect(fixture.componentInstance.movies.length).toEqual(MOVIES.length);
  })
})
